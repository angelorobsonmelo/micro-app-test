package br.com.soluevo.microapplibrary.application.commom.utils.handlers.handlerstatuscode


enum class HandlerErrorStatusCode(val value: Int) :
    MessageStatusCodeError {
